    ...
    private class KeyEventHandler implements EventHandler<KeyEvent> {
        ...
        private String combineList(LinkedList<String> A) {
            ...
            for (int i=0; i<A.size(); i++) {
                ...
                wholeCharacterTyped=wholeCharacterTyped+temp;
                A.addLast(temp);

            }
            return wholeCharacterTyped;
        }
        ...
        public void handle(KeyEvent keyEvent) {
            if (keyEvent.getEventType() == KeyEvent.KEY_TYPED) {
                ...
                // capitalization.
                String characterCurrentTyped = keyEvent.getCharacter();
                if (characterCurrentTyped.length() > 0 && characterCurrentTyped.charAt(0) != 8) {
